...
13.  Turn the wifi on the Pi off if you intend to use your switch/wifiAP instead Network>wireless>Rivendell.  If you intend to us the Pi as the wifiAP, please do alter the country code under advanced settings to your country - by default it is set to NZ New Zealand.  Also rename the SSID and password to your preference.
